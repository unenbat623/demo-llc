...
const SettingsSchema = new mongoose.Schema({
  ...
  heroBadge: { type: String, default: 'Технологийн Шийдэл' },
  heroBadge_en: { type: String, default: 'Tech Solutions' },
  heroStat1Value: { type: String, default: '250+' },
  heroStat1Label: { type: String, default: 'Төсөл' },
  heroStat1Label_en: { type: String, default: 'Projects' },
  heroStat2Value: { type: String, default: '15+' },
  heroStat2Label: { type: String, default: 'Шагнал' },
  heroStat2Label_en: { type: String, default: 'Awards' },
  ...
  aboutBadge_en: { type: String, default: 'About Company' },
  aboutTagline: { type: String, default: 'Innovation First' },

  // Team Section
  teamBadge: { type: String, default: 'Мэргэжлийн баг' },
  teamBadge_en: { type: String, default: 'Expert Minds' },
