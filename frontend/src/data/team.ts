...
/**
 * DEPRECATED: This file contains hardcoded team data.
 * All team members should be fetched from the backend API (/api/team).
 * 
 * Use cases:
 * - Initial seeding to the database (if needed)
 * - DO NOT use as a fallback in frontend components
 * 
 * To add team members to the database:
 * 1. Use the Admin panel to add team members
 * 2. Or POST to /api/team/seed with this data
 */
