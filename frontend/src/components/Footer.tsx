      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-12">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 mb-20 sm:mb-24">
          <div>
            ...
            <p className="text-lg text-gray-400 mb-8 sm:mb-12 max-w-sm">
              Дараагийн үеийн дижитал дэд бүтцийг хамтдаа бүтээцгээе.
            </p>
            <a
            ...
            >
              <span className="relative z-10">Яриагаа эхлүүлцгээе</span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-12">
            <div>
              <h4 className="text-xs font-black uppercase tracking-[0.4em] text-gray-500 mb-6 sm:mb-8">Цэс</h4>
            ...
            <div>
              <h4 className="text-xs font-black uppercase tracking-[0.4em] text-gray-500 mb-6 sm:mb-8">Холбогдох</h4>
        ...
        <div className="pt-12 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-8 text-center md:text-left">
          <div className="text-lg font-black tracking-tighter uppercase">
            Таван <span className="text-gray-500">богд тек</span>
          </div>
          <div className="text-xs font-bold uppercase tracking-[0.2em] text-gray-500 max-w-xs sm:max-w-none">
            © 2026 Таван богд тек ХХК. Бүх эрх хуулиар хамгаалагдсан.
          </div>
        </div>
      </div>
    </footer>
